...
if (typeof gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed !== "undefined") {
  gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed = {};
gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed.idToCallbackMap = new Map();


gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed.func = function(runtimeScene, ControllerIdentifier, Button, parentEventsFunctionContext) {
...
gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed.eventsList0(runtimeScene, eventsFunctionContext);


return !!eventsFunctionContext.returnValue;
}

gdjs.evtsExt__ColouredSpriteMultitouchJoystick__IsButtonPressed.registeredGdjsCallbacks = [];