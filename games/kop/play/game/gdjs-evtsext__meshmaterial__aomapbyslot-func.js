...
gdjs.evtsExt__MeshMaterial__AOMapBySlot.idToCallbackMap = new Map();
gdjs.evtsExt__MeshMaterial__AOMapBySlot.GDObjectObjects1= [];


gdjs.evtsExt__MeshMaterial__AOMapBySlot.userFunc0x2a9be48 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
if (objects.length > 0) {
...
const objects = gdjs.evtsExt__MeshMaterial__AOMapBySlot.GDObjectObjects1;
gdjs.evtsExt__MeshMaterial__AOMapBySlot.userFunc0x2a9be48(runtimeScene, objects, eventsFunctionContext);
